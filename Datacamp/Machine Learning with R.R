...
table(loans$default)
loans$outcome=as.factor(loans$default)
...
library(dplyr)
unemployment <- readRDS(gzcon(url("https://assets.datacamp.com/production/course_3851/datasets/unemployment.rds")))
