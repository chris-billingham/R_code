...
# Automatically pivot by Pclass & Survived!
...
ggplot(female_train, aes(x = Age, fill = Survived)) +
  ...
  labs(y = "Passenger Count",
       x = "Passenger Age",
       title = "Female Survival Rates by Pclass and Age")


# Pivot by Sex, Pclass, and Survived all at the same time!
...
ggplot(titanic_train, aes(x = Age, fill = Survived)) +
  ...
  labs(y = "Passenger Count",
       x = "Passenger Age",
       title = "Survival Rates by Sex, Pclass and Age")
