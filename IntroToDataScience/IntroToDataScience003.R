...
#wiki:https://en.wikipedia.org/wiki/RMS_Titanic

# Load raw data
train <- read.csv("C:/Users/User/Desktop/Mission/R/data/train.csv", header = TRUE)
test <- read.csv("C:/Users/User/Desktop/Mission/R/data/test.csv", header = TRUE)
...
boxplot(fare~survived,data=train, main="fare and survive", 
        xlab="survie", ylab="fare")

p <- ggplot(train, aes(factor(survived), fare))
p + geom_boxplot()
