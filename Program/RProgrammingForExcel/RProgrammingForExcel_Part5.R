...
ss1=sqldf("select Sex as sexy from titanic_train")
ss2=sqldf("select Sex as sexy,count(*) as cnt,count(distinct Name) as Name,
          avg(Age) as Age,sum(Fare) as Fare from titanic_train 
          where Age>30 group by Sex")
ss2
class(ss2)
data()
