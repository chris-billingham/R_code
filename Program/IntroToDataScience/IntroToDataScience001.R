...
#website https://www.youtube.com/watch?v=32o0DnuRjfg&list=PLTJTBoU5HOCRrTs3cJK-PbHM39cwCU0PF
...
data.combined[which(as.character(data.combined$name)=='Kelly, Mr. James'),]
